...
during our work. 
%
\subsection{A note about OpenGL API}
...
%
% parlare delle primitive per disegnare?
%
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=300pt]{img/gltranslate}
...
\begin{figure}[!h]
  \begin{center}
    \includegraphics[width=200pt]{img/glrotate}
