...
\end{figure}
%
Two of the components needed by \texttt{R.E.A.R.}, the robot 
model and the camera, are mapped on two dedicated classes, 
\texttt{Robot} and \texttt{Camera}, respectively.
%

%
While the former provides methods to actually draw a 3d 
representation of the robot... blah blah blah blah
[forse e` meglio rendere la classe Robot privata, 
trattandosi di un framework]
%
...
internally implements the loop showed in figure \ref{blah}, 
