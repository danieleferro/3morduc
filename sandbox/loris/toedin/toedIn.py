...
def setLightColor( s ):
	...
	if lightColors.has_key( s ):
		c = lightColors[ s ]
		glLightfv( GL_LIGHT0, GL_AMBIENT, (1.0, 0.0, 0.0, 1.0) ) # set ambient light parameters
		glLightfv( GL_LIGHT0, GL_DIFFUSE, (1.0, 0.0, 0.0, 1.0) ) # set diffused light parameters
		glLightfv( GL_LIGHT0, GL_SPECULAR, (1.0, 0.0, 0.0, 1.0) ) # set reflected light parameters
		glLightfv( GL_LIGHT5, GL_AMBIENT, c ) # set ambient light parameters
		glLightfv( GL_LIGHT5, GL_DIFFUSE, c ) # set diffused light parameters
		glLightfv( GL_LIGHT5, GL_SPECULAR, c ) # set reflected light parameters
...
# to be called to draw the scene
...
#         glEnable( GL_LIGHT5 )
# 	glLightfv( GL_LIGHT5, GL_POSITION, [4, 4, 4, 1] )
# 	lA = 0.8
# 	glLightfv( GL_LIGHT5, GL_AMBIENT, [lA, lA, lA, 1] )
# 	lD = 1
# 	glLightfv( GL_LIGHT5, GL_DIFFUSE, [lD, lD, lD, 1] )
# 	lS = 1
# 	glLightfv( GL_LIGHT5, GL_SPECULAR, [lS, lS, lS, 1] )
