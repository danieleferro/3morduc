...
float SweepMetricCalc::Calculate(robot_data * robot_status, image_data * bg_image_data) {
...
void SweepMetricCalc::ChooseImage( robot_data * robot_status, image_data * bg_image_data,
