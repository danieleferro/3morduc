...
%
The \textit{Sweep Metric Algorithm}, presented in the next section, 
...
%
To recognize all discarded images, the \tettt{Calculate} method 
...
whithin the \texttit{sweep area}, the robot and image coordinates
