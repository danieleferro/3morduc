...
%
Of course, main issues in such an approch are \textit{where} 
exactly to draw the robot within the viewing frustum and 
\textit{which} of the captured images use is to be used 
as background.
%
\begin{figure}[!h]
  \begin{center}
