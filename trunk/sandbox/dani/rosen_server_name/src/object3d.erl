...
new (Object = #object3d{}) ->
    ...
    io:format("object:new(O) con ~p~n", [Object]),
...
start_link (Module, Params = #object3d {}) ->
  ...
  rosen:add_object (Params#object3d.rosen_name, Pid),
  {ok, Pid}.
...
copy_default_axis (Obj = #object3d{}) ->
  Axis =
    if
      Obj#object3d.axis == undefined ->
	    Obj#object3d.default_axis;
