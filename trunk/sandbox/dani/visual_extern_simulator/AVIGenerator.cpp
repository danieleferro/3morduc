...
CAVIGenerator::CAVIGenerator(LPCTSTR sFileName, CNeheWindow *p, DWORD dwRate)
...
#ifdef _AVIGENERATOR_USE_MFC
void CAVIGenerator::SetBitmapHeader(CNeheWindow *p)
{
	//FILIPPO ASSERT_VALID(pView);

	////////////////////////////////////////////////
	// Getting screen dimensions
	// Get client geometry 
	CRect rect; 
	//FILIPPO pView->GetClientRect(&rect); 
